...
from starmate.variables import fonts
...
class FITSViewer:
    def __init__(self, root, args):
        ...
        self.sidebar_frame = ctk.CTkFrame(self.main_frame, width=200, fg_color=colors.bg)
        ...
        # ComboBox setup
        self.image_selector = ctk.CTkComboBox(selector_frame, height=30, width=150, fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.image_selector.pack(side="left", padx=5, pady=10)
        
        # Button to manually change the image based on ComboBox selection
        change_image_button = ctk.CTkButton(selector_frame, text="Change Image", command=self.change_active_image, font=fonts.md, fg_color=colors.accent, text_color=colors.text)
    ...
    def setup_ui(self):
        ...
        ctk.CTkLabel(self.sidebar_frame, text="Sidebar Content", fg_color=colors.bg, text_color=colors.text, font=fonts.lg).pack(pady=10)
        
        draw_line_button = ctk.CTkButton(self.sidebar_frame, text="Draw Line", command=self.toggle_drawing_mode, font=fonts.md, fg_color=colors.accent, text_color=colors.text)
        ...
        self.file_path_entry = ctk.CTkEntry(file_frame, width=40, fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.file_path_entry.pack(side="left", fill="x", expand=True, padx=5, pady=5)
        
        browse_button = ctk.CTkButton(file_frame, text="Browse FITS File", command=self.open_file_dialog, font=fonts.md, fg_color=colors.accent, text_color=colors.text)
        browse_button.pack(side="right", padx=5, pady=5)
        
        self.hdu_numinput = ctk.CTkEntry(file_frame, width=5, fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.hdu_numinput.pack(side="right", padx=5, pady=5)
        self.hdu_numinput.insert(0, "1")

        hdu_numlabel = ctk.CTkLabel(file_frame, text="HDU Number:", fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        ...
        ctk.CTkLabel(input_frame, text="pmin:", fg_color=colors.bg, text_color=colors.text, font=fonts.md).pack(side="left", padx=5)
        self.pmin_entry = ctk.CTkEntry(input_frame, width=50, fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.pmin_entry.insert(0, "0")
        self.pmin_entry.pack(side="left", padx=5)
        
        ctk.CTkLabel(input_frame, text="pmax:", fg_color=colors.bg, text_color=colors.text, font=fonts.md).pack(side="left", padx=5)
        self.pmax_entry = ctk.CTkEntry(input_frame, width=50, fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.pmax_entry.insert(0, "100")
        self.pmax_entry.pack(side="left", padx=5)
        
        apply_button = ctk.CTkButton(input_frame, text="Apply", command=self.update_image_cache, font=fonts.md, fg_color=colors.accent, text_color=colors.text)
        apply_button.pack(side="left", padx=10)

        # Sidebar Toggle Button
        toggle_sidebar_button = ctk.CTkButton(input_frame, text="Tools", command=self.toggle_sidebar, font=fonts.md, fg_color=colors.accent, text_color=colors.text)
        toggle_sidebar_button.pack(side="right", padx=10)

        # Canvas to display the FITS image with padding
        self.image_canvas = ctk.CTkCanvas(self.content_frame, width=500, height=500, bg=colors.bg)
        ...
        self.x_label = ctk.CTkLabel(coord_frame, text="X:", fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.x_value = ctk.CTkLabel(coord_frame, text="N/A", fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.y_label = ctk.CTkLabel(coord_frame, text="Y:", fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.y_value = ctk.CTkLabel(coord_frame, text="N/A", fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.ra_label = ctk.CTkLabel(coord_frame, text="RA:", fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.ra_value = ctk.CTkLabel(coord_frame, text="N/A", fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.dec_label = ctk.CTkLabel(coord_frame, text="Dec:", fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.dec_value = ctk.CTkLabel(coord_frame, text="N/A", fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.pixel_label = ctk.CTkLabel(coord_frame, text="Pixel:", fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        self.pixel_value = ctk.CTkLabel(coord_frame, text="N/A", fg_color=colors.bg, text_color=colors.text, font=fonts.md)
        ...
        for row, (label, value) in enumerate(labels):
            label.grid(row=row, column=0, padx=10, pady=1, sticky="w")  # Align label to the left (west)
            value.grid(row=row, column=1, padx=10, pady=1, sticky="e")  # Align value to the right (east)
        ...
        self.thumbnail_canvas = ctk.CTkCanvas(thumbnail_frame, width=100, height=100, bg=colors.bg)
